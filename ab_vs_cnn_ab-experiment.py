...
RANDOM_MODEL: keras.Model = load_model('random_model.keras', compile=False)  # open this for random training dataset
# RANDOM_MODEL: keras.Model = load_model('normal_model.keras', compile=False)  # open this for second training dataset
...
class Game:
    ...
    def main(self, epochs=10, delay_between_games=1):
        ...
        print(f"Out of {epochs} games, White won {self.beige_wins} times and Black won {self.brown_wins} times.")
        self.terminate_game()
